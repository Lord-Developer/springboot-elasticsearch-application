package lord.dev.springbootelasticsearchapplication.controller;

import lord.dev.springbootelasticsearchapplication.model.Product;
import lord.dev.springbootelasticsearchapplication.repository.ElasticSearchQuery;
...
public class UIController {
    ...
    public String showFormForUpdate(@PathVariable(value = "id") String id, Model model) throws IOException {
        ...
        return "update-product-document";
    }
